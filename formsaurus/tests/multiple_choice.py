...
from formsaurus.models import (
    Choice, Survey, Submission, MultipleChoiceAnswer)
...
class MultipleChoiceTestCase(TestCase):
    ...
    def test_required_single_multiple_choice(self):
        ...
        answer = answers[0]
        self.assertTrue(isinstance(answer, MultipleChoiceAnswer))
    ...
    def test_required_multiple_multiple_choice(self):
        survey = Survey.objects.create(
            name='Test Survey',
            user=self.user,
            published=True,
        ...
        if first.id == choices[1].id:
            self.assertEqual(second.id, choices[2].id)
        else:
            self.assertEqual(second.id, choices[1].id)


    def test_required_other_multiple_choice(self):
        survey = Survey.objects.create(
            name='Test Survey',
            user=self.user,
            published=True,
    ...
    def test_required_other_multiple_multiple_choice(self):
        survey = Survey.objects.create(
            name='Test Survey',
            user=self.user,
            published=True,
